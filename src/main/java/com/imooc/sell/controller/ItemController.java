...
import com.imooc.sell.controller.viewobject.ItemVO;
import com.imooc.sell.error.BusinessException;
import com.imooc.sell.response.CommonReturnType;
...
public class ItemController extends BaseController {
    ...
    public CommonReturnType createItem(@RequestParam(name="title")String title,
        ...
        ItemModel itemModeForReturn = itemService.createItem(itemModel);
